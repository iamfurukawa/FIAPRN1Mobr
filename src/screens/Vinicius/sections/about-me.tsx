...
const AboutMe = () => {
    return (
      <Section title="Sobre Mim">
        ...
        <Text>{"\t"}Jogo bastante video game, zerei Hogwarts Legacy, mas o meu top 3 jogos são God of War, Horizon e Life is Strange. E ultimamente estou a espera do homem aranha 2.{"\n"}</Text>
        <Text>{"\t"}Maratono uma lista enorme de séries e já perdi muito tempo assistindo Supernatural, Greys Anatomy, Friends e How I met your mother. Atualmente estou esperando novos episódios de Loki.{"\n"}</Text>
